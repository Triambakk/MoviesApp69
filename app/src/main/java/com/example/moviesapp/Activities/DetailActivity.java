...
import com.example.moviesapp.Adapters.CastListAdapter;
 ...
 binding=ActivityDetailBinding.inflate(getLayoutInflater());
    ...
    private void setVariable() {
        ...
        if (item.getGenre() != null) {
            ...
            binding.genreView.setLayoutManager(new LinearLayoutManager(this, androidx.recyclerview.widget.LinearLayoutManager.HORIZONTAL, false));

        }

        if (item.getCasts() != null){
            binding.CastView.setLayoutManager(new LinearLayoutManager(this, androidx.recyclerview.widget.LinearLayoutManager.HORIZONTAL,false));
